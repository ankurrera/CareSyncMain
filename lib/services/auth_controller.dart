...
class AuthController {
  ...
  bool _needsBiometricSetup(Map<String, dynamic>? device) {
    ...
    return device['biometric_enabled'] != true || device['trusted'] != true;
  }
  ...
  Future<SessionRestoreResult> restoreSession() async {
    ...
    try {
      ...
      _log('[AUTH] Unexpected error restoring session: $e');
      return SessionRestoreResult.loginRequired;
    }
  }
  ...
  void _log(String message) {
    AppLogger.debug(message, category: LogCategory.auth);
  }
}

/// Result of the main sign-in flow
enum AuthFlowResult { success, kycRequired }

/// Result of session restoration
enum SessionRestoreResult { success, loginRequired, biometricFailed }
